...
def poetry():
    ...
    #chooses random number of lines between 3 and 10
    numLines = random.randint(3, 10)

    #assigns a random number of elements to each line and makes each line a list
    #combines all of the lines into a list of lists
    ...
    #converts list of lists to formatted string for reading and writing to file
...
def r4u():
    ...
    if aloud in ['n', 'N', 'no', 'No', 'NO', 'Nope', 'No thanks', 'No thank you', 'No thx', 'no thx', 'nah', 'no way']:
        print()
        print("OK! No problem!")
        print()
        fileQ()
